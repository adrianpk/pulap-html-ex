defmodule Pulap.Repo.Migrations.CreatePlanSubscriptions do
  ...
  def change do
    create table(:plan_subscriptions, primary_key: false) do
      ...
      add :created_by_id, references(:plan_subscriptions, type: :binary_id, on_delete: :nothing)
      add :updated_by_id, references(:plan_subscriptions, type: :binary_id, on_delete: :nothing)
